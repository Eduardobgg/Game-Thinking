...
public class JuegoDecision {
    public static void main (String args []){
        ...
        int camino= 0, camino1= 0, equipamento= 0, camino2=0, camino3= 0, escondite= 0;
        String nombre;
        ...
        if (camino == 1){
            ...
            if (camino1== 1){
                ...
                if (equipamento==1){
                    ...
                    if (camino3== 1){
                        System.out.println("Tienes 1 min para buscar un escondite, ya que la criatura sintio tu presencia y va directo hacia tu cuarto");
                        System.out.println("Donde te escondes: ");
                        System.out.println("1. Ropero");
                        System.out.println("2. Debajo de tu cama");
                        System.out.println("3. Te envuelves en tus cobijas");
                        escondite= entrada.nextInt();
                        if (escondite==1){
                            System.out.println("El ropero no tiene tanto espacio para que entres, la criatura te alcanzo, mala decisión");
                        } else if (escondite== 2) {
                            System.out.println("Buena elección has sobrevivido a la criatura...");
                            System.out.println("Al llegar la policia no encuentra nada, tu familia esta muerta y no sabes como explicar lo que sucedio...");
                            System.out.println("Bailas para que crean que estas loco, es mejor el manicomnio que la carcel...");
                        } else if (escondite==3) {
                            System.out.println("al destaparte te encuentresas sudando...");
                            System.out.println("Tuviste un mal sueño...");
            ...
            System.out.println("Al tratar de retomar el sueño entra bruscamente una criatura entra a tu cuarto y se te mata brutalmente");
        } else {
            System.out.println("Opción invalida");
        }
    }
